...
public class Test {
	public static RestHighLevelClient client = RHLESClient.client;
	public static void main(String[] args) throws IOException {
		RHLESClient.initEsClient();
		RHLESClient.closeEsClient();
	}
	...
	public static boolean isIndexExist(String index) throws IOException {
            ...
            return RHLESClient.client.indices().exists(request, RequestOptions.DEFAULT);
	}
